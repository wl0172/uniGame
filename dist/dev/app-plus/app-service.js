...
(function(vue, shared) {
  ...
  const goodsRef = vue.ref(goods);
  const mapRef = vue.ref(map);
  const _imports_1 = "/static/image/11.png";
      ...
      postUserInfo({
        ...
        if (res == null ? void 0 : res.fighter) {
          const getMon = monsterRef.value.find((item) => {
            var _a2;
            return item.id == ((_a2 = res == null ? void 0 : res.fighter) == null ? void 0 : _a2.index);
          });
    ...
    if (Object.keys(battleInfo.value.monster).length) {
      ...
      getFightFind().then((res) => {
        if (res) {
          ...
          txtCopywriting(beforeMonster, txtArr2, 0, scrollIndex2);
        }
      });
    }
  };
              ...
              vue.createElementVNode("div", { class: "comBattleDiv_battle_1_div" }, [
                Object.keys((_a = vue.unref(battleInfo)) == null ? void 0 : _a.monster).length ? (vue.openBlock(), vue.createElementBlock("div", {
                  ...
                  vue.createElementVNode("progress", {
                    ...
                    backgroundColor: progressConfig.backgroundColor,
                    active: progressConfig.active,
                    percent: vue.unref(bloodShow)(vue.unref(battleInfo).monster, 1)
                  }, null, 8, ["border-radius", "stroke-width", "backgroundColor", "active", "percent"]),
                  vue.createElementVNode("div", { class: "comBattleDiv_battle_1_div_blood1" }, vue.toDisplayString((_e = (_d = vue.unref(battleInfo)) == null ? void 0 : _d.monster) == null ? void 0 : _e.hp), 1)
        ...
        return vue.openBlock(), vue.createElementBlock("div", {
          ...
          vue.createElementVNode("div", { class: "forgeDiv_conter" }, [
            ...
            vue.createElementVNode("div", { class: "comBattleDiv_battle_1" }, [
              ...
              vue.createElementVNode("div", {
                class: "comBattleDiv_battle_1_div",
                style: { "background": "#fff5e1" }
              }, [
                vue.createElementVNode("div", { class: "comBattleDiv_battle_1_divs" }, [
                  vue.createCommentVNode(" \u94B1 "),
                  vue.createElementVNode("div", { class: "right_money" }, [
                    vue.createElementVNode("div", null, "\u4EBA\u6C11\u5E01\uFF1A"),
                    vue.createElementVNode("div", null, "\u91D1\u5E01\uFF1A"),
                    vue.createElementVNode("div", null, "\u94F6\u5E01\uFF1A"),
                    vue.createElementVNode("div", null, "\u94DC\u5E01\uFF1A")
                  ]),
                  vue.createElementVNode("div", { class: "comBattleDiv_battle_1_div_i_name" }, vue.toDisplayString(vue.unref(battleInfo).player.name), 1),
          ...
          vue.createElementVNode("div", { class: "conSceneListL" }, [
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(pageArr).list, (item, index) => {
              return vue.openBlock(), vue.createElementBlock("div", {
                ...
                vue.unref(sceneName)(item.linked) ? (vue.openBlock(), vue.createElementBlock("div", {
                  key: 0,
                  class: "conSceneListLi_txt"
                }, "\u53EF\u53BB\uFF1A" + vue.toDisplayString(vue.unref(sceneName)(item.linked)), 1)) : vue.createCommentVNode("v-if", true),
                vue.unref(monsterName)(item.monsters) ? (vue.openBlock(), vue.createElementBlock("div", {
                  key: 1,
                  class: "conSceneListLi_txt"
                }, "\u5F53\u524D\u602A\uFF1A" + vue.toDisplayString(vue.unref(monsterName)(item.monsters)), 1)) : vue.createCommentVNode("v-if", true)
              ], 8, ["onClick"]);
            }), 128))
          ])
        ]);
