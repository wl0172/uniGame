...
exports.default = (options) => {
    ...
    const normalizeComponentName = (_a = options.template.component) === null || _a === void 0 ? void 0 : _a.normalizeName;
    return [
        (options) => {
            var _a, _b;
            return (0, mainJs_1.uniMainJsPlugin)({
                normalizeComponentName,
                babelParserPlugins: (_b = (_a = options.vueOptions) === null || _a === void 0 ? void 0 : _a.script) === null || _b === void 0 ? void 0 : _b.babelParserPlugins,
            });
        },
        ...
        (0, renderjs_1.uniRenderjsPlugin)({ lang: (_b = options.template.filter) === null || _b === void 0 ? void 0 : _b.lang }),
